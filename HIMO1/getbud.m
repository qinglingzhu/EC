...
%         bd=zeros(1,30);bu=ones(1,30);  testfunction='ZDT5';
    ...
    case 31
       bd=zeros(1,11);bu=ones(1,11);  testfunction='DTLZ1-7';
    case 32
        bd=zeros(1,13);bu=ones(1,13);  testfunction='DTLZ1-9';
    case 33
        bd=zeros(1,16);bu=ones(1,18);  testfunction='DTLZ3-7';
    case 34
        bd=zeros(1,18);bu=ones(1,18);  testfunction='DTLZ3-9';
    case 35
        bd=zeros(1,14);bu=ones(1,14);  testfunction='DTLZ3-5';
    case 36
        bd=zeros(1,9);bu=ones(1,9);  testfunction='DTLZ1-5';
    case 37
        bd=zeros(1,8);bu=ones(1,8);  testfunction='DTLZ1-4';
    case 38
        bd=zeros(1,13);bu=ones(1,13);  testfunction='DTLZ2-4';
    case 39
        bd=zeros(1,14);bu=ones(1,14);  testfunction='DTLZ2-5';
    case 40
        bd=zeros(1,16);bu=ones(1,16);  testfunction='DTLZ2-7';
otherwise
